...
node 'review.incloud-ci.com' {
  ...
  class { 'openstack_project::review':
    ...
    ssh_rsa_key_contents                => hiera('uni_ssh_rsa_key_contents'),
    ssh_rsa_pubkey_contents             => hiera('uni_ssh_rsa_pubkey_contents'),
    ssh_project_rsa_key_contents        => hiera('uni_ssh_rsa_key_contents'),
    ssh_project_rsa_pubkey_contents     => hiera('uni_ssh_rsa_pubkey_contents'),
    ssh_replication_rsa_key_contents    => hiera('uni_ssh_rsa_key_contents'),
    ssh_replication_rsa_pubkey_contents => hiera('uni_ssh_rsa_pubkey_contents'),
...
node 'singlenode.incloud-ci.com' {
  ...
  class { '::openstackci::single_node_ci':
    ...
    jenkins_ssh_private_key     => hiera('uni_ssh_rsa_key_contents'),
    jenkins_ssh_public_key      => hiera('uni_ssh_rsa_pubkey_contents'),
    gerrit_server               => hiera('gerrit_server', 'review.openstack.org'),
    gerrit_user                 => hiera('gerrit_user'),
    gerrit_user_ssh_public_key  => hiera('uni_ssh_rsa_pubkey_contents'),
    gerrit_user_ssh_private_key => hiera('uni_ssh_rsa_key_contents'),
